...
const Index = () => {
  const apologyContent = [
    ...
    "Nv block chesthav ani mundhe telusu,ala behave chesthe block chesthav ane ala behave chesa and I thought if i become that kind of person u would hate me and it makes easy for u to forget about me and be happy and i am sorry nenu mundhe anukuna ala behave chesthe block chesthav ani atleast I won in this😁,i know this is not me I made sure to behave in that to get blocked which worked and koncham emotional kuda ayya I lost my calmness ",
    ...
    "Nenu spoil chesanu ante nenu em cheyali nv kuda nannu friend ani anukovali ga parathi sari nene anni initiate chesthe okasari na side nunchi alochinchi chudu appudu nike ardhamavuthundhi enduku overthink chesano ani and be with people who dont make you suffocate like i did or who dont irritate like i did which made u to block me and naku telusu niku chala mandhi friends unnaru ani nenu important kadhu ani but if need me anytime just unblock chesi oka message cheyu I will be there within seconds for you, remember I will always care for u and be there for u I promised that❤️‍🩹",
